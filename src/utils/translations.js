...
window.I18n.translations = {
    es: {
        ...
        accommodation: {
            ...
            subtitle:
                'Alojamiento verificado y gestionado directamente por nuestro equipo, en toda Europa. Reserva con confianza.',
        },
        trips: {
            eyebrow: 'Viajes Erasmus',
            title: 'Muévete por Europa',
            subtitle:
                'Viajes y excursiones organizados directamente por nuestro equipo para que te muevas por Europa sin complicaciones ni sorpresas.',
        },
        listing: {
        ...
        notfound: {
            eyebrow: 'Error 404',
            title: 'Este grupo ya no existe',
            subtitle:
                'Como en tu primer día de Erasmus: te has perdido. Por suerte, aquí no hace falta preguntar por la calle.',
            chat_contact_name: 'Esta página',
            chat_last_seen: 'última conexión: nunca',
            chat_incoming_intro: 'Épale 👋 Preguntabas por esto:',
            chat_incoming_outro: 'Pero aquí no hay nadie con ese nombre.',
            chat_outgoing: 'Vaya… 😅 ¿Seguro que no le diste a un enlace roto?',
            chat_typing_sr: 'El grupo está escribiendo…',
            chat_system_message: 'Esta página salió del grupo',
            path_label: 'Ruta que intentaste abrir',
            after_chat_lead: 'Pero por aquí sí hay sitio 👇',
            cta_home: 'Ir al inicio',
            cta_cities: 'Ver ciudades',
            cta_map: 'Abrir el mapa',
        },
    },
    en: {
        nav: {
        ...
        accommodation: {
            ...
            subtitle:
                'Verified accommodation managed directly by our team, across Europe. Book with confidence.',
        },
        trips: {
            eyebrow: 'Erasmus travel',
            title: 'Get around Europe',
            subtitle:
                'Trips and excursions organized directly by our team so you can get around Europe without hassle or surprises.',
        },
        listing: {
        ...
        notfound: {
            ...
            subtitle:
                'Like your first day on Erasmus: you got lost. Luckily, no need to ask a stranger for directions here.',
            chat_contact_name: 'This page',
            chat_last_seen: 'last seen: never',
            chat_incoming_intro: 'Hey 👋 you were asking about this:',
            chat_incoming_outro: "But there's no one here by that name.",
            chat_outgoing: "Uh oh… 😅 sure you didn't tap a broken link?",
            chat_typing_sr: 'The group is typing…',
            chat_system_message: 'This page left the group',
            path_label: 'Path you tried to open',
            after_chat_lead: "But there's plenty of room over here 👇",
            cta_home: 'Go home',
            cta_cities: 'Browse cities',
