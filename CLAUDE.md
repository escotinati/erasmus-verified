...
La idea es que TODAS las cards de la web sean miembros de la misma familia (`Card.jsx`), distinguidas por qué slots y qué `cta.kind` llevan. **Fase 1 (hecha)**: partner-card + event-card del home. Pendientes, cada una en su propia rama: `city-partners-card` (`CityPartnerList.jsx`), `collab-card` y `service-card` (HTML estático en alojamiento/viajes/servicios), `city-card` (`ciudades.js`/`ciudades-todas.html`).

### Qué hace cada archivo

| Archivo                             | Qué hace                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `src/react/Card.jsx`                | La card única de la web. Una sola estructura (media → body → footer) con **slots opcionales**: `imageUrl`/`imageAlt`/`badge`, `title`/`meta`/`date`/`price`/`description` y `cta: { kind, label, href, onClick }`. Un slot sin valor no se renderiza — cada tipo de card (anunciante de partner, evento, y en fases futuras alojamiento, servicio, ciudad) es una combinación de slots, no un componente aparte. `CTA_KINDS` es el único sitio donde se define cada tipo de botón: `info` (enlace de texto, se revela en hover con puntero fino) y `tickets` (botón relleno siempre visible); un tipo nuevo = una entrada ahí + su modificador `.card-cta--<kind>` en `card.css`. Sanea `imageUrl`/`cta.href` con `sanitizeUrl()`. Estilos en `src/css/card.css` (`.card`, `.card__media`, `.card__badge`, `.card__body`…); lo que depende del contenedor (carrusel/grid de eventos, `.card--featured`) sigue en `home.css` bajo `.events-scroll .card`. |
